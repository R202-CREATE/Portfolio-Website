      ...
      >
        <div className={styles.wrapper}>
          <div className={styles.leftSection}>
            <Image
              src="C:\Users\reefa\Downloads\Portfolio-Website-master\Portfolio-Website-master\public\img\portfolio-image (2).jpeg"
              alt=""
              width="800px"
              height="1000px"
          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.iconContainer}>
              ...
              <Link href="https://github.com/R202-CREATE">
                <i className={styles.icons}>
                  <VscGithub />
                </i>
              </Link>
              <Link href="https://www.linkedin.com/in/reefan-ahamed">
                <i className={styles.icons}>
                  <FaLinkedin />
                </i>
              </Link>
